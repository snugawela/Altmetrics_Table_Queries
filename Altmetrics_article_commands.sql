...
select seq.nextval, content:citation:doi::varchar, content:citation:title::varchar, content:altmetric_id::bigint, to_char(current_timestamp, 'YYYY-MM-DD HH:MM:SS'), to_char(current_timestamp, 'YYYYMMDD'),
