-- History
CREATE OR REPLACE TABLE "DEV2_EDW"."ALTMETRICS"."ALT_FACT_ARTICLE_ALTMETRIC_SCORE_FIELDS" (
	ARTICLE_ALTMETRIC_SCORE_FIELD_ID BIGINT,
	ARTICLE_ID BIGINT,
	HISTORY_PERIOD_ID BIGINT,
	ALTMETRIC_SCORE DOUBLE,
