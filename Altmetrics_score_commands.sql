CREATE OR REPLACE TABLE "DEV2_LZ"."ALTMETRICS"."ALT_FACT_ARTICLE_ALTMETRIC_SCORES" (
	ARTICLE_ALTMETRIC_SCORE_ID BIGINT,
	ARTICLE_ID BIGINT,
	DAYS_ALTMETRIC_SCORE DOUBLE,
	TOTAL_ALTMETRIC_SCORE DOUBLE,
...
insert into "DEV2_LZ"."ALTMETRICS"."ALT_FACT_ARTICLE_ALTMETRIC_SCORES" (ARTICLE_ALTMETRIC_SCORE_ID, ARTICLE_ID, DAYS_ALTMETRIC_SCORE,
...
where not exists (select ARTICLE_ID from "DEV2_LZ"."ALTMETRICS"."ALT_FACT_ARTICLE_ALTMETRIC_SCORES"
