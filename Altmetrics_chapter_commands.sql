--
CREATE OR REPLACE TABLE "DEV2_LZ"."ALTMETRICS"."ALT_DIM_ARTICLES_CHAPTERS" (
	ARTICLE_CHAPTER_ID BIGINT NOT NULL,
	ARTICLE_ID BIGINT NOT NULL,
	CHAPTER_ALTMETRIC_ID BIGINT NOT NULL,
...
insert into "DEV2_LZ"."ALTMETRICS"."ALT_DIM_ARTICLES_CHAPTERS"(ARTICLE_CHAPTER_ID, ARTICLE_ID, CHAPTER_ALTMETRIC_ID, ORDINAL_NUMBER, TITLE, TIMESTAMP_OF_INSERT, PERIOD_ID_OF_INSERT)
select seq.nextval, chapter.ARTICLE_ID, chapter.content:altmetric_id, chapter.content:citation:ordinal_number, content:citation:title,
